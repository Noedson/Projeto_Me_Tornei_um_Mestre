...
\vspace{0.5cm}
\noindent \textbf{Fonte(s):}

\vspace{0.5cm}
\noindent \textbf{Data/período da Busca:}
...
\begin{verbatim}
- ("Desenvolvimento de Software" OR "Construção de Software" OR "Ciclo de Vida") AND 
  (Jogos OR Gamificação) AND (Ensino OR Educação)
\end{verbatim}
